<header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>#/" class="logo">
        ...
        <span class="logo-mini"> <img style="padding-bottom:5px;"   width="35px" height="35px" src="<?php echo base_url(); ?>assets/ico/apple-icon-57x57.png" class=""> </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">
        <!--<img   height="35px" src="<?php echo base_url(); ?>assets/ico/bizi-logo.png" class="">-->
            <img style="padding-bottom:5px;"  width="35px" height="35px" src="<?php echo base_url(); ?>assets/ico/apple-icon-57x57.png" class="">
            <span style="padding-left:3px; font-size: 23px;"><b>BIZ</b>-i</span>
        </span>
    </a>
