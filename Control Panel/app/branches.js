biziApp.controller('branchesController', function ($scope) {
    ...
    $scope.grid_refrash = function () {
        ...
        $.ajax({
            url: base_url + "Inventory_load/get_branches_grid",
            type: "POST",
            dataType: 'json',
            ...
            success: function (response) {
                ...
                $scope.$apply(function () //to reset dropdown
                {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        oTable.fnAddData([i + 1, response[i]['branch_name'],
    ...
    $scope.save_data_grid = function () {
        ...
        $.ajax({
            url: base_url + "inventory_save/branches_save",
            type: "POST",
            dataType: 'json',
